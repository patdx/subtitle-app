...
export const SyncPill = () => {
	...
	return (
		<Link
			...
			className="pointer-events-auto absolute left-1/2 top-3 z-20 flex -translate-x-1/2 items-center gap-1.5 rounded-full border border-ink-700 bg-black/60 px-2.5 py-1 text-xs font-medium text-ink-200 backdrop-blur transition-colors hover:text-white"
		>
